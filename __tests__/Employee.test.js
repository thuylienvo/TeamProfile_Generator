...
test('getId() returns id number', () => {
    ...
    const testNewEmployee = new Employee(testInputEl, testInputEl, "mimzy414@gmail.com");
...
test('getEmail() returns email', () => {
    const testInputEl = 'mimzy414@gmail.com';
    const testNewEmployee = new Employee(testInputEl, 1234, testInputEl);
